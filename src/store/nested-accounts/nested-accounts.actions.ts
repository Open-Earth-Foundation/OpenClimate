...
export const doLoadGeoSubnational = ( countryName: string) => {
    return (dispatch: Dispatch) => {
        ...
        GeoService.getSubnationalsByCountry(countryName).then((fetchedGeoSubnational: IGeoSubnational) => {
...
export const doLoadClimateActions = (siteName: string) => {
    return (dispatch: Dispatch) => {
       ...
       climateActionService.getClimateActionsBySite(siteName).then((climateActions:Array<IClimateAction>) => {
