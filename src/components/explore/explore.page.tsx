                    ...
                    <div>
                        <form>
                                            ...
                                            <ul role="menu" className='explore__select' aria-label='Countries'>
                                                {
                                                    nations.map((item: INation) =>(
                                                        <button onClick={setStateValue} className='explore__btn-options' data-id={item.country_id} value={item.country_name}>{item.country_name}</button>
                                                    ))
                                                }
                                            </ul>
                                        </div>
                            ...
                            <div className='explore__submit-button explore__submit'>
                                <a href={`/emissions/${nationId}`} className=''>Explore</a>
                            </div>
                        </form>
                    </div>
                </>
