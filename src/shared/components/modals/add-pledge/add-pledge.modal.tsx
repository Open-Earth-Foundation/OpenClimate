...
const AddPledgeModal: FunctionComponent<Props> = (props) => {
    ...
    return (
        ...
        <form autoComplete="off" action="/" className="pledge-form" onSubmit={handleSubmit(submitHandler)} noValidate>
            ...
            <div className="modal__content modal__content-btm-mrg">
                ...
                {extraFields.map((ps: any, index: number) => {
                    return (
                            <div className="modal__row modal__row_content" key={`${target}_${ps.name}_${index}`}>
                                <InputText 
                                    type={ps.type}
