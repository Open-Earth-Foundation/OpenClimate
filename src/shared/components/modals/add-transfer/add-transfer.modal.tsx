...
const AddTransferModal: FunctionComponent<Props> = (props) => {
    ...
    const submitHandler = (data: any) => {
        ...
        const countryName = CountryCodesHelper.GetCountryNameByAlpha3(data['transfer_receiver_country']);
        data['transfer_receiver_country'] = countryName;

        const jurisdiction = CountryCodesHelper.GetRegionNameByCode(data['transfer_receiver_jurisdiction']);
    ...
    return (
        <form autoComplete="off" action="/" className="transfer-form" onSubmit={handleSubmit(submitHandler)}>
