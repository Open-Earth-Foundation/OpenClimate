...
const ClimateActionsSummary: FunctionComponent<IProps> = (props) => {
    ...
    useEffect(() => {
        ...
        const scope1EmsTotal = ClimateActionHelper.GetSumC02(scope1EmsActions, 'facility_emissions_scope1_co2e');
        ...
        const scope2EmsTotal = ClimateActionHelper.GetSumC02(scope2EmsActions, 'facility_emissions_scope2_co2e');
        ...
        const scope3EmsTotal = ClimateActionHelper.GetSumC02(scope3EmsActions, 'facility_emissions_scope3_co2e');
        ...
        const scope1MtsTotal = ClimateActionHelper.GetSumC02(scope1MtsActions, 'facility_emissions_scope1_co2e');
        ...
        const scope2MtsTotal = ClimateActionHelper.GetSumC02(scope2MtsActions, 'facility_emissions_scope2_co2e');
        ...
        const scope3MtsTotal = ClimateActionHelper.GetSumC02(scope3MtsActions, 'facility_emissions_scope3_co2e');
                    ...
                    <tr className="account__scope-row_red">
                        <td>
                            <ScopeTileCentered 
                                ...
                                onClick={()=> showModal('emission-filters')}
                            />
                        </td>
                        <td>
                            <ScopeTile 
