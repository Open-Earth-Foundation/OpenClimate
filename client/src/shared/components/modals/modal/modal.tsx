...
interface IDispatchProps {
    ...
    addClimateAction: (site: ISite) => void
}
...
const Modal: FunctionComponent<IProps> = (props) => {
    ...
    const { user, modalConfig, sites, climateActions,
        showModal, hideModal, doLogin, addPledge, addTransfer, addSite, addClimateAction } = props;
    ...
    switch(modalConfig.entityType)
    {
        ...
        case 'emission-filters':
            title = ""
            component = <EmissionFilters climateActions={climateActions} />
            break;
        case 'add-pledge':
        ...
        case 'add-transfer':
            title = "Add transfer"
            component = <AddTransferModal onModalHide={hideModal} addTransfer={addTransfer} user={user} />
            break;
