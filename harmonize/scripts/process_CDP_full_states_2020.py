def harmonize_emissions(fl=None, reportingYear=None, fl_climactor=None, datasourceDict=None):
    ...
    df_final['emissions_id'] = df_final.apply(lambda row:
                                              f"CDP_full_states_regions_2020:{row['actor_id']}:{row['year']}",
                                              axis=1)
...
if __name__ == "__main__":
    ...
    outputDir = "../data/processed/CDP_full_states_regions_2020/"
    ...
    # path to raw dataset
    fl = '../data/raw/CDP_full_states_regions_2020/2020_-_Full_States_and_Regions_Dataset.csv'
