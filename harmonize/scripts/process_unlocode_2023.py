...
INPUT_DIR = '../data/raw/unlocode/loc232csv'
OUTPUT_DIR = '../data/processed/UNLOCODE_2023-2'
...
DATASOURCE = {
    "datasource_id": "UNLOCODE:2023-2",
    "name": "UN/LOCODE (CODE FOR TRADE AND TRANSPORT LOCATIONS) Issue 2023-2",
...
def read_subdivs():
    subdivs = {}
    with open(f'{INPUT_DIR}/2023-2 SubdivisionCodes.csv', encoding='iso-8859-1') as csvfile:
...
def main():
    ...
    for i in [1, 2, 3]:
        with open(f'{INPUT_DIR}/2023-2 UNLOCODE CodeListPart{i}.csv', encoding='iso-8859-1') as csvfile:
