...
if __name__ == '__main__':
    # output directory
    outputDir = '../data/processed/IEA2023/'
    outputDir = os.path.abspath(outputDir)
    make_dir(path=Path(outputDir).as_posix())

    # raw data file path
    fl = '../data/raw/IEA2023/GHGHighlights.XLS'
    ...
    # =================================================================
    datasourceDict = {
        'datasource_id': 'IEA:GHG_energy_highlights:2023',
        ...
        'citation': 'IEA. (2023). Greenhouse Gas Emissions from Energy Highlights [Data set]. IEA. https://www.iea.org/data-and-statistics/data-product/greenhouse-gas-emissions-from-energy-highlights'
    }
