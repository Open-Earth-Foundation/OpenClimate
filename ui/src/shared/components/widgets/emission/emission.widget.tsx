...
import {
  getCityProviders,
  getEmissionProviders,
  getSubnationalProviders,
} from "../../../helpers/get-emission-providers.helper";
...
const EmissionWidget: FunctionComponent<Props> = (props) => {
  ...
  const [currentEmissions, setEmissions] = React.useState<EmissionInfo>(
    {} as EmissionInfo
  );
  ...
  const changeDataSource = async (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const source = await getChangedEmissionData(
  ...
  if (aggregatedEmission)
    showDetails =
      aggregatedEmission.facility_ghg_total_gross_co2e !== 0 ||
  ...
  switch (entityType) {
    case 0:
      if (aggregatedEmission && !src) {
        ...
        tags = aggregatedEmission?.facility_ghg_methodologies?.map(
          ...
          {selectedEntity ? (
            <div className={`widget__emission-content ${className}`}>
              <div className="widget__emission-numbers">
                <div className="widget__content-column">
                  <div className="widget__emission-data red text-top">
                    <img
                      src={ArrowUpRed}
                      alt="up"
                      className="widget__emission-arrow"
                    />
                ...
                <div className="widget__content-column widget__content-column_center">
                  -
                </div>
                ...
                <div className="widget__content-column text-top red">
                  <div className="widget__emission-data">
                    {(selectedEntity.total_scope_emissions -
                      selectedEntity.total_scope_mitigations) /
                      1000000.0}
                  </div>
                  <div className="widget__emission-data-description">
            ...
            <div className="widget__no-data">
              No data sourced yet. Have any suggestions, contact
              ux@openearth.org!
            </div>
          )}
        </div>
      ...
      {aggregatedEmission?.credential_category === "Climate Action" ? (
        <div className="widget__wrapper">
          <div className="widget__header">
            ...
            <span className="widget__updated">
              Last Updated {aggregatedEmission?.facility_ghg_date_updated} |
              Data shown refers to {aggregatedEmission?.facility_ghg_year}
            </span>
          </div>
                  ...
                  <div className="widget__content-column">
                    <div className="widget__emission-data red text-top">
                      <img
                        ...
                        className="widget__emission-arrow"
                      />
                      {aggregatedEmission?.facility_ghg_total_gross_co2e?.toFixed(
                        2
                      )}
                    </div>
                    <div className="widget__emission-data-description">
                  ...
                  <div className="widget__content-column text-top">
                    <div className="widget__emission-data green">
                      <img
                        ...
                        className="widget__emission-arrow"
                      />
                      {aggregatedEmission?.facility_ghg_total_sinks_co2e?.toFixed(
                        2
                      )}
                    </div>
                    <div className="widget__emission-data-description">
            ...
            {aggregatedEmission?.facility_ghg_total_gross_co2e ? (
              <div className={`widget__emission-content ${className}`}>
                ...
                {!!currentEmissions?.landSinks && (
                  <div
                    className={`widget__emission-numbers widget__emission-block`}
                  >
                ...
                <div className="widget__meta-data">
                  ...
                  <div className="widget__meta-text-right">
                    <span className="widget__meta-source-head">
                      Methodology
                    </span>
                    <div className="widget__methodology-tags">
                      ...
                      {tags && tags?.length > 2 && (
                        <Tooltip
                          ...
                          arrow
                        >
                          <span className="widget__meta-source-m">{`+${
                            tags?.length - 2
                          }`}</span>
                        </Tooltip>
                      )}
