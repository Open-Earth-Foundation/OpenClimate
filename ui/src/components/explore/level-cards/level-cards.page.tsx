    ...
    <div className="level__card">
      <div className="page">
        <div>
          ...
          >
                ...
                >
                  ...
                  {countrySelected ? (
                    <>
                      ...
                      {countryExpanded ? (
                        <ArrowDropUp sx={{ color: "#1C1B1F" }} />
                      ) : (
                        <ArrowDropDown sx={{ color: "#1C1B1F" }} />
                      )}
                      <div
            ...
            <Collapse in={countryExpanded} timeout="auto" unmountOnExit>
              ...
              <div className="dropdown-select">Brazil</div>
            </Collapse>
          </Card>
        </div>
          ...
          >
            ...
            >
              <div className="content">
                <div
                  className="dropdown"
                  onClick={() => setSubnationalExpanded(!subnationalExpanded)}
                >
                  <Search />
                  {subnationalSelected ? (
                    <>
                      ...
                      <div
                        className="dropdown-cross-icon"
                        onClick={() => setSubnationalSelected(false)}
                      >
                        <HighlightOff />
                      </div>
                    </>
            ...
            <Collapse in={subnationalExpanded} timeout="auto" unmountOnExit>
              <div className="dropdown-select">British Columbia</div>
              <div
                className="dropdown-select"
                onClick={() => {
                  setSubnationalSelected(!subnationalSelected);
                  setSubnationalExpanded(false);
                }}
              >
                Alberta
              </div>
        ...
        <div>
          ...
          <button
            className="swapto-button"
            onClick={() => setCompanySelected(!companySelected)}
          >
