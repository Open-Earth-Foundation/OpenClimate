...
const ClimateActionsSummary: FunctionComponent<IProps> = (props) => {
  ...
  useEffect(() => {
    ...
    const scope3EmsActions = ClimateActionHelper.GetClimateActions(
      climateActions,
      ClimateActionScopes.Scope3,
      ClimateActionTypes.Emissions
    );
    const scope3EmsTotal = ClimateActionHelper.GetSumC02(
      scope3EmsActions,
      "facility_emissions_co2e"
    );
    ...
    const scope3MtsActions = ClimateActionHelper.GetClimateActions(
      climateActions,
      ClimateActionScopes.Scope3,
      ClimateActionTypes.Mitigations
    );
    const scope3MtsTotal = ClimateActionHelper.GetSumC02(
      scope3MtsActions,
      "facility_mitigations_co2e"
    );
    ...
    setTiles([
      {
        ...
        total: scope1EmsTotal,
        climateActions: scope1EmsActions,
      },
      {
        scope: ClimateActionScopes.Scope2,
        type: ClimateActionTypes.Emissions,
        total: scope2EmsTotal,
        climateActions: scope2EmsActions,
      },
      {
        scope: ClimateActionScopes.Scope3,
        type: ClimateActionTypes.Emissions,
        total: scope3EmsTotal,
        climateActions: scope3EmsActions,
      },
      {
        scope: ClimateActionScopes.Scope1,
        type: ClimateActionTypes.Mitigations,
        total: scope1MtsTotal,
        climateActions: scope1MtsActions,
      },
      {
        scope: ClimateActionScopes.Scope2,
        type: ClimateActionTypes.Mitigations,
        total: scope2MtsTotal,
        climateActions: scope2MtsActions,
      },
      {
        scope: ClimateActionScopes.Scope3,
        type: ClimateActionTypes.Mitigations,
        total: scope3MtsTotal,
        climateActions: scope3MtsActions,
      },
      {
        scope: ClimateActionScopes.Scope1,
        type: ClimateActionTypes.Summary,
        total: scope1SummaryTotal,
        climateActions: [defaultCLimateAction],
      },
      {
        scope: ClimateActionScopes.Scope2,
        type: ClimateActionTypes.Summary,
        total: scope2SummaryTotal,
        climateActions: [defaultCLimateAction],
      },
      {
        scope: ClimateActionScopes.Scope3,
        type: ClimateActionTypes.Summary,
        total: scope3SummaryTotal,
        climateActions: [defaultCLimateAction],
      },
    ]);
      ...
      <table className="account__climate-actions-table">
        ...
        <tbody>
          <tr className="account__scope-row_red">
            ...
            <td>
              <ScopeTile
                climateActionTile={tiles.find(
                  (t) =>
                    t.scope == ClimateActionScopes.Scope1 &&
                    t.type == ClimateActionTypes.Emissions
                )}
                scope={ClimateActionScopes.Scope1}
                type={ClimateActionTypes.Emissions}
                addOffset={!user.demo}
            ...
            <td>
              <ScopeTile
                climateActionTile={tiles.find(
                  (t) =>
                    t.scope == ClimateActionScopes.Scope2 &&
                    t.type == ClimateActionTypes.Emissions
                )}
                scope={ClimateActionScopes.Scope2}
                type={ClimateActionTypes.Emissions}
            ...
            <td>
              <ScopeTile
                climateActionTile={tiles.find(
                  (t) =>
                    t.scope == ClimateActionScopes.Scope3 &&
                    t.type == ClimateActionTypes.Emissions
                )}
                scope={ClimateActionScopes.Scope3}
                type={ClimateActionTypes.Emissions}
            ...
            <td>
              <ScopeTile
                climateActionTile={tiles.find(
                  (t) =>
                    t.scope == ClimateActionScopes.Scope1 &&
                    t.type == ClimateActionTypes.Mitigations
                )}
                scope={ClimateActionScopes.Scope1}
                type={ClimateActionTypes.Mitigations}
                addOffset={!user.demo}
            ...
            <td>
              <ScopeTile
                climateActionTile={tiles.find(
                  (t) =>
                    t.scope == ClimateActionScopes.Scope1 &&
                    t.type == ClimateActionTypes.Summary
                )}
                scope={ClimateActionScopes.Scope1}
                showModal={showModal}
                wallets={wallets}
