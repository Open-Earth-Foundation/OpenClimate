  ...
  useEffect(() => {
    const amount = climateActions.reduce((a: number, n: IClimateAction) => {
      ...
      if (n.credential_type) {
        const cType =
          ClimateActionTypes[
            n.credential_type as keyof typeof ClimateActionTypes
          ];
      ...
      <div className="emissions-card__content">
        <div className="emissions-card__header">
          ...
          <div className="emissions-card__title">
            <h3>{cardTitle}</h3>
            <span className="emissions-card__header-date">
        ...
        <div className="emissions-card__data">
          <div className="emissions-card__total-amount">
            <div
              className={`emissions-card__amount ${
                totalAmount > 0 ? "amount-red" : "amount-green"
              }`}
            >
              {totalAmount}
            </div>
            <span className="emissions-card__total-amount-description">
              Mt CO2e/year
            </span>
          </div>
        </div>
