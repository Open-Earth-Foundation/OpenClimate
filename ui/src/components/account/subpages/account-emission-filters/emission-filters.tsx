...
const EmissionFilters: FunctionComponent<IProps> = (props) => {
    ...
    useEffect(() => {
        ...
        if(showFilters)
        {
            const sc1 = displayItems.filter(a => a.climate_action_scope?.toString() === ClimateActionScopes[ClimateActionScopes.Scope1]);
            const sc2 = displayItems.filter(a => a.climate_action_scope?.toString() === ClimateActionScopes[ClimateActionScopes.Scope2]);
            const sc3 = displayItems.filter(a => a.climate_action_scope?.toString() === ClimateActionScopes[ClimateActionScopes.Scope3]);
