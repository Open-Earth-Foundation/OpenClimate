      ...
      {hasReadHint ? (
        <div className="review-collaboration-card-hint">
          <div className="collaboration-card-header">
            <span>
              Want to <br /> contribute with data?
            </span>
            <CloseIcon
              onClick={setCollabCookieValue}
              className="collaboration-card-close-icon"
            />
          </div>
          <div className="collaboration-card-body">
            <p>
              Find out how to be <br /> a part of the <br />{" "}
              <span>independent stocktaking effort</span> <br /> by
              collaborating <br /> with us.
            </p>
          </div>
