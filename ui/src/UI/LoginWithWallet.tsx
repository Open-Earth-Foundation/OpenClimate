...
import { ContentCopy, QrCode, InfoOutlined, CopyAll } from '@mui/icons-material'


import { createTheme, ThemeProvider } from '@mui/material/styles';
import { IUser } from '../api/models/User/IUser';
import { Clickable, CopyText, InfoText, InlineClickable, SuccessText } from './CommonStyles';
      ...
      <PageContainer>
          <FormContainer isQRStep>
              <LoginContainer isQRPage={isQRPage}>
                  ...
                  <HeadingSubtext>Scan this QR with your digital wallet to login. You will have to complete the request for proof of credentials</HeadingSubtext>
                  <QRBox>
                  ...
                  <ActionContainer>
                    ...
                    <InfoTxt>or you can use the Demo Access if you don’t have a verified credential yet. </InfoTxt>
          ...
          <StepperContainer>
              <NetworkStatusContainer>
                <NetInfoText>
                  Make sure your wallet is set up to the correct network before interacting with this invitation or request.
                </NetInfoText>
                <NetInfoText>
                  <p>Network:<b>&nbsp; &nbsp;Bcovrin Test Network</b></p>
                </NetInfoText>
              </NetworkStatusContainer>
              <StepperWrapper>
                <HeaderText>Steps to complete login</HeaderText>
                <HeaderInfoText>Here's what you can expect from this login process.</HeaderInfoText>
                <Stepper
                  activeStep={0}
